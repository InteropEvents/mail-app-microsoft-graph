...
function CreateMail() {
    ...
    GetMyProfile().then(function (me) {
        var date = new Date();
        form.address.value = "weilin@microsoft.com"
        form.subject.value = "Microsoft DevDays 2019: Build the cloud mail App";
        content.html("I built the mail App to send mail in Microsoft DevDays Shanghai 2019 - Hello from " + me.displayName);
    })
}
