...
(function ($) {
    $.oauth2 = function (options, successCallback, errorCallback) {
        ...
        var loginWindow = options.response_type === "code" ?
            window.open(login_url, '_blank', 'location=yes,clearsessioncache=yes') :
            window.open(login_url, '_self', 'location=yes,clearsessioncache=yes');
                    ...
                    if (code) {
                        $.ajax({
                            ...
                            data: {
                                ...
                                scope: options.other_params.scope
                            },
                            type: 'POST',
